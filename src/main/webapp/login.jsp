...
<body class="dark-mode">
	...
	<div class="login-card">
		...
		%>
		<p style="color: green; text-align: center;">Registration
			successful! Please log in.</p>
		<%
		}
		}
		String isMismatch = request.getParameter("error");
		if (isMismatch != null) {
		if ("mismatch".equals(isMismatch)) {
		%>
		<p style="color: red; text-align: center;">Please Enter Valid
