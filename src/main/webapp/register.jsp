...
<link
	...
	rel="stylesheet" />
<link rel="stylesheet" href="register.css?v=2025">
...
<script defer src="register.js?v=2025"></script>
</head>
<body>
		...
		<main class="main-content">
			...
			<div class="register-card glass animate-up">
				...
				<div class="alert warning">
					<i class="ri-alert-line"></i> Username/Email already exists. Try
					logging in.
				</div>
				<%
				}
				...
				%>
				<div class="alert error">
					<i class="ri-close-circle-line"></i> Something went wrong. Please
					try again.
				</div>
				<%
				}
