...
public class CashFreeClientView extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if (amountStr == null) throw new Exception("Amount is missing");
            ...
            String returnUrl = "http://localhost:8080/TrainTicketBookingApplication/PaymentSuccess?source=CASHFREE&order_id={order_id}";
